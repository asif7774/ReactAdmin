...
const ComponentsOverview = () => (
  <React.Fragment>
    ...
    <Container fluid className="main-content-container px-4 slim-scroll">
      <Row>
        <Col lg="12">
          <Alert className="mb-0 mt-3">
            <i className="material-icons mx-2">info</i> How you doin'? I'm just a friendly, good-looking notification message and I come in all the colors you can see below. Pretty cool, huh?
          </Alert>
        </Col>
      </Row>
