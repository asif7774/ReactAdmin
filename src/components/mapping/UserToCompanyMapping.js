...
//   return columns;
// }
class UserToCompanyMapping extends React.Component {
  constructor() {
    super();
                  ...
                  return (
                    <React.Fragment>
                      <Row className="pb-2">
                        ...
                        <Col sm="12">
                          <h5 className="px-3 mt-2 d-flex align-items-center mb-0 mt-3">
                            <span>Newly Mapped Employees</span>
                          </h5>
                          <div className="py-2 px-3 table-responsive">
...
export default UserToCompanyMapping;
